    ...
    >
      <div className="relative aspect-square overflow-hidden bg-slate-100">
        ...
        <button
          ...
          className="absolute bottom-3 right-3 w-9 h-9 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center shadow-md hover:bg-rose-50 hover:text-rose-500 text-slate-400 transition-colors"
        >
